 package grupo10.tpo.demo.exception;
...
import grupo10.tpo.demo.exception.pedido.PedidoNotFoundException;
import grupo10.tpo.demo.exception.producto.PrecioNegativoException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RecursosDuplicadosException.class)
    public ResponseEntity<String> manejarRecursosDuplicados(RecursosDuplicadosException ex) {
